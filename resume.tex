  ...
  \item {\bf Ph.D. in Applied Mathematics}, University of Washington,
    ...
    \begin{itemize*}
      \item Design and implementation of algebraic-numerical hybrid
        ...
        ``abelfunctions''.
      \item Applying research results to computing periodic solutions to
        a large class of nonlinear partial differential equations using
        techniques from algebraic geometry.
      \item Focus on designing high performance code in both computer
        algebraic and numerical aspects of the software package.
...
%    \begin{itemize}
%      \item Created a Python Implementation of the basic functionality of
%        Chebyshev functions.
%      \item
%    \end{itemize}
